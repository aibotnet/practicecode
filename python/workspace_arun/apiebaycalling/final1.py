...
def APIreq2call(item_id , page_count): 
    i=1
    while i <= page_count :
...
def APIreq1call(item_id , page_count , pid): 
    i=1
    while i <= page_count :
...
def main():
    ...
    #item_id="170982536675"
    #item_id="261366532009"
    #item_id="261291125053"
    #item_id="111233588699"
    item_id="350719611764"   
    ...
    if check_list :
        ...
        if(api_request_number==2) :          
            APIreq2call(item_id , page_count)
            
            
        
        elif (api_request_number==1) :
            APIreq1call(item_id , page_count , pid)
