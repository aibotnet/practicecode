...
def main():
    ...
    count=0
    f=open('/home/aknauhwar/Desktop/ebay testing/EbayFinal/Fianl feb7/ebaytext.txt' , "a")
    f1=open('/home/aknauhwar/Desktop/ebay testing/EbayFinal/Fianl feb7/ebay_no_Compatibility_list.txt' , "a")  #no list or bad url or removed product or no item_id
    f2=open('/home/aknauhwar/Desktop/ebay testing/EbayFinal/Fianl feb7/ebay_list_count.txt' , "a")   
    f3=open('/home/aknauhwar/Desktop/ebay testing/EbayFinal/Fianl feb7/ebay_debugging.txt' , "a")  #for any other error
    input=open('/home/aknauhwar/Desktop/ebay testing/EbayFinal/ebay final input/input_feb7' , "r")
    input_string= input.readlines()
    for input_data in input_string[0:] :
        #time.sleep(1)
        if(input_data) :
