...
def APIreq2call(item_id , page_count , f , input_data ,f2 ,f1): 
    i=1
    result=[]
    k=0
    while i <= page_count :
...
def APIreq1call(item_id , page_count , pid , f , input_data , f2 ,f1): 
    i=1
    while i <= page_count :
...
def main():
    ...
    count=531
    #count=360 
    f=open('/home/aknauhwar/Desktop/ebay testing/test/ebaytext1.txt' , "a")
    f1=open('/home/aknauhwar/Desktop/ebay testing/test/ebay_no_Compatibility_list.txt' , "a")  
    f2=open('/home/aknauhwar/Desktop/ebay testing/test/ebay_list_count.txt' , "a")   
 
    input=open('/home/aknauhwar/Desktop/ebay testing/eBaySample-5000-Parts1.txt' , "r")
    input_string= input.readlines()
    for input_data in input_string[531:2400] :
        if(input_data) :
            ...
            if item_id :   
                        ...
                        if check_list :
                            ...
                            if(api_request_number==2) :          
                                APIreq2call(item_id , page_count , f , input_data ,f2 ,f1 )
                                
                                
                            
                            elif (api_request_number==1) :
                                APIreq1call(item_id , page_count , pid , f , input_data ,f2 , f1)
