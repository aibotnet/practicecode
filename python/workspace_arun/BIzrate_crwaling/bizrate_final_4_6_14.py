...
def main():   
    f=open('/home/aknauhwar/Desktop/bizrate_text_finalmerchantinfo5.txt' , "w")
    departments=['other-products', 'pet-supplies', 'sports-equipment-outdoor-gear', 'toys-games', 'video-games-accessories']
