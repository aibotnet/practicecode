...
def main():
    f=open('/home/vkthakur/Desktop/bizrate_data/bizrate_text_finalmerchantinfo2.txt', "w")

    departments = ['clothing-accessories', 'computers-software', 'electronics', 'gifts-flowers-food','health-beauty-supplies','home-garden']
