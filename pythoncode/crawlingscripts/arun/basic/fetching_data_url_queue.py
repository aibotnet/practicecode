...
output=open('/root/Arun/sql_url_data2', "w")
with con:
   ...
   # i=1 
    while 1  :
        ...
        cur.execute("select product_id , uid ,url from url_queue where rdomain='com.amazon.www' and is_disabled=0 and metadata like '%july%' limit {0},1000".format(start_row)
