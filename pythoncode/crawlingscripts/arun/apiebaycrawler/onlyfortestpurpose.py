...
def main():
    ...
    count=2934
    f=open('/home/aknauhwar/Desktop/ebay testing/onlytest/ebaytext3.txt' , "a")
    f1=open('/home/aknauhwar/Desktop/ebay testing/onlytest/ebay_no_Compatibility_list3.txt' , "a")  
    f2=open('/home/aknauhwar/Desktop/ebay testing/onlytest/ebay_list_count3.txt' , "a")   
 
    input=open('/home/aknauhwar/Desktop/ebay testing/eBaySample-5000-Parts1.txt' , "r")
    input_string= input.readlines()
    for input_data in input_string[2934:] :
        time.sleep(1.5)
        if(input_data) :
...
print time.time() - start_time, "seconds this is the time for whole run og this script"  
