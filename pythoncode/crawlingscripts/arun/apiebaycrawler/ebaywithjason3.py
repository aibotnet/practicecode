...
def APIreq2call(item_id , page_count , f , input_data): 
    i=1
    result=[]
    k=0
    while i <= page_count :
...
def APIreq1call(item_id , page_count , pid , f , input_data): 
    i=1
    while i <= page_count :
            ...
            if item_id :   
                        ...
                        if check_list :
                            ...
                            if(api_request_number==2) :          
                                APIreq2call(item_id , page_count , f , input_data)
                                
                                
                            
                            elif (api_request_number==1) :
                                APIreq1call(item_id , page_count , pid , f , input_data)
