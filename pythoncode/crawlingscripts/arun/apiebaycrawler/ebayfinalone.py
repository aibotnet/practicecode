    ...
    while i <= page_count:
        ...
        try:
            ...
            try:
                ...
                f1.write(
                    input_data + '    #still double quote(i.e 21",) problen or invalid json' + "on page %d of json" % i + "\n")
                i = i + 1
                continue
            except:
                f1.write(
        ...
        for rs in daata:
            ...
            f.write(
                input_data + "|" + FitmentComments + "|" + Year + "|" + Make + "|" + Model + "|" + Trim + "|" + Engine + "\n")
...
def main():
    ...
    count = 1000
    f = open('/home/aknauhwar/Desktop/ebay testing/ebaytext1.txt', "a")
    f1 = open('/home/aknauhwar/Desktop/ebay testing/ebay_no_Compatibility_list.txt', "a")
    f2 = open('/home/aknauhwar/Desktop/ebay testing/ebay_list_count.txt', "a")

    input = open('/home/aknauhwar/Desktop/ebay testing/eBaySample-5000-Parts1.txt', "r")
    input_string = input.readlines()
    for input_data in input_string[1000:2400]:
        if (input_data):
